...
void q8_pair_concat_mma_launch(Q8PairScheduleId schedule, bool full, const Tensor& x,
    ...
    case Q8PairScheduleId::ConcatMmaR32C64:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<32, 64, 32, 16, 3>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR32C80:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<32, 80, 32, 16, 3>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR32C96:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<32, 96, 32, 16, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR32C112:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<32, 112, 32, 16, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR32C128:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<32, 128, 32, 16, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR48C64:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<48, 64, 48, 16, 3, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR48C96:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<48, 96, 48, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR48C112:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<48, 112, 48, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR48C128:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<48, 128, 48, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR64C64:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<64, 64, 64, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR64C80:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<64, 80, 64, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR64C96:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<64, 96, 64, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR64C128:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<64, 128, 64, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR96C64:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<96, 64, 48, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR96C80:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<96, 80, 48, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR96C96:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<96, 96, 48, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR96C112:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<96, 112, 48, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR128C64:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<128, 64, 64, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    case Q8PairScheduleId::ConcatMmaR128C80:
        dispatch_variant<Q8RowSplitMmaGemmSchedule<128, 80, 64, 16, 2, 2>>(
            full, x, first_weight, first_out, second_out, stream);
        return;
    default:
