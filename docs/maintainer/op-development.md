...
Report the full pointwise curve, core points individually, affected priority points and intervals,
...
around relevant transitions and as few broad routes as the
